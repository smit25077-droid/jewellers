...
class JewellerDetailsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final currentJeweller = controller.jewellers.firstWhereOrNull(
      (j) => j.id == jeweller.id,
    ) ?? jeweller;
    ...
    return GetBuilder<MasterAdminController>(
      builder: (_) {
        ...
        final updatedJeweller = controller.jewellers.firstWhereOrNull(
          (j) => j.id == jeweller.id,
        ) ?? currentJeweller;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildInfoCard([
                    _buildInfoTile(Icons.person, 'Owner Name', updatedJeweller.name),
                    _buildInfoTile(Icons.phone, 'Phone', updatedJeweller.phone),
                    _buildInfoTile(Icons.email, 'Email', updatedJeweller.email),
                  ]),
                  ...
                  _buildInfoCard([
                    ListTile(
                      ...
                      subtitle: Text(
                        updatedJeweller.isActive == true ? 'Active' : 'Inactive',
                        style: TextStyle(
                          fontSize: 16,
